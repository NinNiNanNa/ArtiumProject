                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <ul class="nav nav-pills mb-4" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active tabColor" data-bs-toggle="pill" href="#current">현재전시</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tabColor" data-bs-toggle="pill" href="#future">예정전시</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tabColor" data-bs-toggle="pill" href="#past">만료전시</a>
                                </li>
                            </ul>
